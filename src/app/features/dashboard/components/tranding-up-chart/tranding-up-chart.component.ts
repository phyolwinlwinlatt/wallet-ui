...
@Component({
  selector: 'app-tranding-up-chart',
  standalone: true,
  imports: [AgCharts],
  templateUrl: './tranding-up-chart.component.html',
  styleUrl: './tranding-up-chart.component.css',
})
export class TrandingUpChartComponent {
      ...
      series: [
        {
          ...
          fill: '#E8EBFD', ////#EAF3FE (border: #C8E3FE), #E8EBFD (border: #919AFF) // gradient (border also gri)
          strokeWidth: 2,
          stroke: '#919AFF',
        },
      ],
